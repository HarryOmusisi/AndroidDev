...
import com.example.harryapp.AccessTokenInterceptor;

import static com.example.harryapp.Constants.BASE_URL;
import static com.example.harryapp.Constants.CONNECT_TIMEOUT;
import static com.example.harryapp.Constants.READ_TIMEOUT;
import static com.example.harryapp.Constants.WRITE_TIMEOUT;

import com.example.harryapp.STKPushServices;
...
public class DarajaApiClient {
    ...
    private Retrofit getRestAdapter() {
        ...
        if (isGetAccessToken) {
            okhttpBuilder.addInterceptor(new com.example.harryapp.AccessTokenInterceptor());
        }
